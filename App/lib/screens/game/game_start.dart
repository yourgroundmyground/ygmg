                                    ...
                                    Padding(
                                      ...
                                      child: Visibility(
                                        ...
                                        child: Userprofile(
                                          ...
                                          text3: rankingInfoList.isNotEmpty ? (rankingInfoList[0].areaSize*10000000000).toStringAsFixed(0) : '',
                                        ),
                                      ),
                                    ),
                                    Padding(
                                      ...
                                      child: Visibility(
                                        ...
                                        child: Userprofile(
                                          ...
                                          imageProvider: NetworkImage(
                                            ...
                                            text3: rankingInfoList.length > 1 ? (rankingInfoList[1].areaSize*10000000000).toStringAsFixed(0) : '',
                                        ),
                                      ),
                                    ),
                                    Padding(
                                      ...
                                      child: Visibility(
                                        ...
                                        child: Userprofile(
                                          ...
                                          text3: rankingInfoList.length > 2 ? (rankingInfoList[2].areaSize*10000000000).toStringAsFixed(0) : '',
